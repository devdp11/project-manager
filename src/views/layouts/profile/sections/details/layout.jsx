        ...
        <>
            ...
            <div className='bg-white mt-12 p-4'>
                ...
                <form className="mt-8 grid gap-x-6 gap-y-8 grid-cols-1">
                    ...
                    <TextField id="oldpassword" label="Old Password" type={showOldPassword ? "text" : "password"}
                        variant="outlined" required fullWidth
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <TextField id="newpassword" label="New Password" type={showNewPassword ? "text" : "password"}
                            variant="outlined" required fullWidth
                        ...
                        <TextField id="confirmnewpassword" label="Confirm Password" type={showConfirmPassword ? "text" : "password"}
                            variant="outlined" required fullWidth
                            autoComplete='new-password'
                            InputProps={{
                                endAdornment: (
